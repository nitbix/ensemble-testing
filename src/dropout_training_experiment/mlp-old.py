...
def old_rprop(param,learning_rate,gparam,mask,updates,current_cost,previous_cost,
          eta_plus=1.5,eta_minus=0.5,max_delta=50, min_delta=10e-8):
...
#	      (3000,0.5,'h0',T.tanh),
	...
	for eta_plus in [1.01,1.1,1.2,1.5]:
	    for min_delta in [10e-3,10e-4,10e-6,10e-8,10e-10]:
	        for max_delta in [0.5,5,50,500]:
		    print "PARAMS:"
