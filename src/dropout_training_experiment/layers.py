...
class Layer(object):
	"""
	Common parts between different layer types go here.
	"""
	
	def __init__(self,rng,input,activation,dropoutRate,layerName,W=None,b=None):
        self.input = input
...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        :param activation: Non linearity to be applied in the hidden
                           layer
        """
		super.__init__(rng,input,activation,dropout_rate,layer_name,W,b)
...
class ConvolutionalLayer(Layer):
	...
	"""
    def __init__(self, rng, input, input_shape, filter_shape, poolSize, W=None, b=None,
		...
		super.__init__(rng,input.reshape(input_shape),activation,dropout_rate,layer_name,W,b)
		...
		self.conv_out = conv.conv2d(
			input=self.input, filters=self.W, filter_shape=filter_shape,
